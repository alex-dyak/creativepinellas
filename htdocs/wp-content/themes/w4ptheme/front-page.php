		...
		<?php if ( have_posts() ) : ?>
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<section class="homeSection homeSection--homeIntro">
					<div class="row homeSection-text">
						<div class="medium-11 medium-centered large-uncentered large-8 column">
							<?php if ( get_field( 'title_what_is_section' ) ) : ?>
								<h1><?php echo strip_tags( get_field( 'title_what_is_section' ) ); ?></h1>
							<?php endif; ?>
							<?php if ( get_field( 'text_what_is_section' ) ) : ?>
								<p><?php echo strip_tags( get_field( 'text_what_is_section' ) ); ?><br></p>
							<?php endif; ?>
						</div>
					</div>
					<?php
					...
					$row_counter = 0;
					?>
					<div class="row small-collapse homeSection--homeIntro-gridList">
							...
							<div class="medium-4 column">
								...
								<div class="promoList-item">
									<?php if ( get_sub_field( 'venue_directory' ) ) : ?>
										<a href="<?php the_sub_field( 'venue_directory' ); ?>" class="js-touchFocus">
											...
											<div class="promoList-item-body">
												...
												<?php if ( get_sub_field( 'color_explore_art_venues' ) ) : ?>
													<span class="promoList-item-categoryDecor"
											...
											<span class="btn btn--white"><?php echo strtoupper( get_sub_field( 'button_text_explore_art_venues' ) ); ?></span>
												</div>
											<?php endif; ?>
										</a>
									<?php endif; ?>
					...
					<div class="row homeSection-text">
						<div class="medium-11 medium-centered large-uncentered large-8 column">
							<?php if ( get_field( 'title_for_the_art_community' ) ) : ?>
								<h1><?php echo strip_tags( get_field( 'title_for_the_art_community' ) ); ?></h1>
							<?php endif; ?>
							<?php if ( get_field( 'text_for_the_art_community' ) ) : ?>
								<p><?php echo strip_tags( get_field( 'text_for_the_art_community' ) ); ?><br></p>
							<?php endif; ?>
						</div>
					</div>
					<?php
								...
								<?php if ( get_sub_field( 'url_community' ) ) : ?>
									<a href="<?php the_sub_field( 'url_community' ); ?>"
									   class="communitySection-link" data-equal>
										<?php if ( $img_id ) : ?>
											<span class="communitySection-link-imgLayer"
										...
										<?php if ( get_sub_field( 'title_community' ) ) : ?>
											<span class="communitySection-link-text js-equalizer"><?php the_sub_field( 'title_community' ); ?></span>
										<?php endif; ?>
									</a>
								<?php endif; ?>
							</div>
					...
					<div class="row homeSection-text">
						<div class="medium-11 medium-centered large-uncentered large-8 column">
							<?php if ( get_field( 'title_our_journal' ) ) : ?>
								<h1><?php echo strip_tags( get_field( 'title_our_journal' ) ); ?></h1>
							<?php endif; ?>
							<?php if ( get_field( 'text_our_journal' ) ) : ?>
								<p><?php echo strip_tags( get_field( 'text_our_journal' ) ); ?><br></p>
							<?php endif; ?>
						</div>
					</div>
